...
Color aegisDialogBackgroundColor = Colors.black.withOpacity(0.5);

/// A route used for Dialog navigation, implementation can be referred to from _DialogRoute
class AegisDialogRoute<T extends Object?> extends PopupRoute<T> {
  AegisDialogRoute(
...
class AegisMaterialPageRoute<T> extends PageRoute<T> {
  AegisMaterialPageRoute({
...
Future<T?> showAegisDialog<T extends Object?>({
  ...
  return Navigator.of(context, rootNavigator: true).push<T>(AegisDialogRoute<T>(
    ...
    barrierColor: barrierColor ?? aegisDialogBackgroundColor,
...
Future<T?> showAegisDialogUntilAnimateFinish<T extends Object?>({
  required BuildContext context,
  required WidgetBuilder builder,
  bool? barrierDismissible,
  String? barrierLabel,
...
Future<T?> showAegisActionDialogUntilAnimateFinish<T extends Object?>({
  required BuildContext context,
  required WidgetBuilder builder,
  bool? barrierDismissible,
  String? barrierLabel,
  ...
  return showAegisDialogUntilAnimateFinish<T?>(
    context: context,
    builder: builder,
    barrierDismissible: barrierDismissible,
    barrierLabel: barrierLabel,
...
Future<T?> showAegisActionDialog<T extends Object?>({
  required BuildContext context,
  required WidgetBuilder builder,
  bool? barrierDismissible,
  String? barrierLabel,
