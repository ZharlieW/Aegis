...
void _clientAuthDBISARSerialize(
  ...
  writer.writeLong(offsets[1], object.authMode);
...
extension ClientAuthDBISARQuerySortBy
  ...
  QueryBuilder<ClientAuthDBISAR, ClientAuthDBISAR, QAfterSortBy>
      sortByAuthMode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'authMode', Sort.asc);
    });
  }
  ...
  QueryBuilder<ClientAuthDBISAR, ClientAuthDBISAR, QAfterSortBy>
      sortByAuthModeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'authMode', Sort.desc);
    });
  }
...
extension ClientAuthDBISARQueryWhereDistinct
  ...
  QueryBuilder<ClientAuthDBISAR, ClientAuthDBISAR, QDistinct>
      distinctByAuthMode() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'authMode');
    });
  }
...
extension ClientAuthDBISARQueryProperty
  ...
  QueryBuilder<ClientAuthDBISAR, int, QQueryOperations> authModeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'authMode');
    });
  }
